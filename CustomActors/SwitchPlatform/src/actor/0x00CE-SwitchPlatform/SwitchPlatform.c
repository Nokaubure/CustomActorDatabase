...
#define OBJ_ID  0x80      
#define ACT_ID  0xCE
#define OBJ_H  "object/0x0080-SwitchPlatform.h"
#define STATE_OFF  0
#define STATE_ON   1
#define TYPE_ROT 0
#define TYPE_PATH 1
...
void init(SwitchPlatform *en, PlayState *play) {
    ...
    CollisionHeader_GetVirtual((void*)gMovingplatform_CollPlatform,&colHeader);
...
static void draw(SwitchPlatform *en, PlayState *play) {
        ...
        Gfx_DrawDListOpa(play,(Gfx*)gMovingplatform_DlPlatform);
