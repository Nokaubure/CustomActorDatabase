...
#define ACT_ID 0x007B
#define OBJ_ID 0x007E
...
static DamageTable sDamageTable = {
    ...
    /* Explosives     */ DMG_ENTRY(6, 0xF),
    /* Boomerang      */ DMG_ENTRY(4, 0xF),
...
void EnPr2_Init(Actor* thisx, PlayState* play) {
    ...
    this->actor.naviEnemyId = 0xB4;
    this->unk_1EC = 255;
    this->actor.colChkInfo.health = 1;
    this->actor.colChkInfo.damageTable = &sDamageTable;

    SkelAnime_InitFlex(play, &this->skelAnime, 0x06004188, 0x06004340, this->jointTable,
                       this->morphtable, 5);
    ...
    if (this->unk_1E0 < 10) {
        ...
        if (this->unk_1E0 == 3) {
            if (this->actor.parent != NULL) {
                ...
                //if (parent->update != NULL) {
                //    this->pathIndex = ((encount1*)parent)->pathIndex;
...
void func_80A745FC(EnPr2* this, PlayState* play) {
    ...
    //Audio_PlayActorSfx2(&this->actor, NA_SE_EN_PIRANHA_EXIST - SFX_FLAG);
    SoundEffect_PlayHeld(SOUND_ENEMY_SKULLFISH_LURK, 1.0f, 1.0f, 1.0f, &this->actor.world.pos, 0.0f, 1000.0f, &this->actor);
        ...
        switch (this->unk_1E0) {
            ...
            case 2:
                if (this->unk_1DE == 0) {
                    ...
                    if (sp48 && (player->stateFlags1) && (sqrtXZ < this->unk_208)) {
                        sp4C = true;
                        func_80A74DEC(this, play);
                    }
                } else {
...
void func_80A74DEC(EnPr2* this, PlayState* play) {
    ...
    SoundEffect_PlayOneshot(SOUND_ENEMY_SKULLFISH_CHASE, 1.0f, 1.0f, &this->actor.world.pos, 0.0f, 1000.0f, &this->actor);
...
void func_80A74E90(EnPr2* this, PlayState* play) {
    ...
    Math_ApproachF(&this->unk_204, 0.02f, 0.1f, 0.005f);
    if ((this->unk_1D8 == 0) || !(player->stateFlags1) || (this->unk_1E0 == 0)) {
        func_80A74888(this);
        return;
    }
...
void func_80A751B4(EnPr2* this) {
    ...
    if (this->unk_1E0 < 10) {
        ...
        this->unk_1F8 = Animation_GetLastFrame(0x06003904);
        Animation_Change(&this->skelAnime, 0x06003904, 1.0f, this->unk_1F8, this->unk_1F8, ANIMMODE_ONCE,
                         0.0f);
    ...
    if (this->unk_1E0 < 10) {
        ...
        if (this->unk_1F8 <= frame) {
            for (i = 0; i < ARRAY_COUNT(this->unk_234); i++) {
                Actor_Spawn(&play->actorCtx, play, ACT_ID, this->unk_234[i].x, this->unk_234[i].y,
...
void func_80A755D8(EnPr2* this, PlayState* play) {
    ...
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        if ((this->actor.colChkInfo.health <= 0) && (this->unk_1D4 != 3)) {
            ...
            SoundEffect_PlayOneshot(SOUND_ENEMY_SKULLFISH_DIE, 1.0f, 1.0f, &this->actor.world.pos, 0.0f, 1000.0f, &this->actor);
