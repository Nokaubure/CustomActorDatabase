...
#define OBJ_ID 0x00B2
#define OBJ_H "object/0x007F-SwitchPillar.h"
#define STATE_OFF  -1
#define STATE_ON   1
...
{gSwitchpillar_DlSinglepillar, 
gSwitchpillar_DlTriplepillar};

const CollisionHeader* CollisionShape[] = 
{gSwitchpillar_CollSinglepillar, 
gSwitchpillar_CollTriplepillar};

const void* Textures[] = 
{gSwitchpillar_TexNormalpillar, 
gSwitchpillar_TexTriforcepillar};
