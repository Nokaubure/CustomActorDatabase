...
#define gSunBlockEmptyDL 0x06000170
#define gSunBlockDL 0x06000178
#define gSunBlockTLUT 0x06000258
#define gSunBlockTex 0x06000278
#define gSunBlockCol 0x06000B80
